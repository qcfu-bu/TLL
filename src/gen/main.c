...
intptr_t splitting_tree_616; intptr_t splitting_ctree_640;
intptr_t cmsort_704; intptr_t mklistU_739; intptr_t mklistL_746;
intptr_t list_lenU_753; intptr_t list_lenL_761; intptr_t print_listU_769;
intptr_t print_listL_787;
...
intptr_t fn1_idU_814(intptr_t* env) {
  intptr_t A_2; intptr_t m_3; intptr_t x_815;
  A_2 = env[1];
  m_3 = env[2];
...
intptr_t fn1_idL_817(intptr_t* env) {
  intptr_t A_5; intptr_t m_6; intptr_t x_818;
  A_5 = env[1];
  m_6 = env[2];
...
intptr_t fn1_sing_elimUU_844(intptr_t* env) {
  intptr_t A_64; intptr_t x_65; intptr_t __66; intptr_t x_845;
  A_64 = env[1];
  x_65 = env[2];
  __66 = env[3];
...
intptr_t fn1_sing_elimUL_847(intptr_t* env) {
  intptr_t A_68; intptr_t x_69; intptr_t __70; intptr_t x_848;
  A_68 = env[1];
  x_69 = env[2];
  __70 = env[3];
...
intptr_t fn1_sing_elimLU_850(intptr_t* env) {
  intptr_t A_72; intptr_t x_73; intptr_t __74; intptr_t x_851;
  A_72 = env[1];
  x_73 = env[2];
  __74 = env[3];
...
intptr_t fn1_sing_elimLL_853(intptr_t* env) {
  intptr_t A_76; intptr_t x_77; intptr_t __78; intptr_t x_854;
  A_76 = env[1];
  x_77 = env[2];
  __78 = env[3];
...
intptr_t fn1_and_859(intptr_t* env) {
  intptr_t __83; intptr_t __84; intptr_t x_860;
  __83 = env[1];
  __84 = env[2];
...
intptr_t fn1_or_862(intptr_t* env) {
  intptr_t __88; intptr_t __89; intptr_t x_863;
  __88 = env[1];
  __89 = env[2];
...
intptr_t fn1_xor_865(intptr_t* env) {
  intptr_t __93; intptr_t __94; intptr_t x_866;
  __93 = env[1];
  __94 = env[2];
...
intptr_t fn1_lte_871(intptr_t* env) {
  intptr_t __104; intptr_t __105; intptr_t x_872;
  __104 = env[1];
  __105 = env[2];
...
intptr_t fn1_lt_874(intptr_t* env) {
  intptr_t x_114; intptr_t y_115; intptr_t x_875;
  x_114 = env[1];
  y_115 = env[2];
...
intptr_t fn1_add_880(intptr_t* env) {
  intptr_t __124; intptr_t __125; intptr_t x_881;
  __124 = env[1];
  __125 = env[2];
...
intptr_t fn1_sub_883(intptr_t* env) {
  intptr_t __132; intptr_t __133; intptr_t x_884;
  __132 = env[1];
  __133 = env[2];
...
intptr_t fn1_mul_886(intptr_t* env) {
  intptr_t __140; intptr_t __141; intptr_t x_887;
  __140 = env[1];
  __141 = env[2];
...
intptr_t fn0_div_888(intptr_t x_148, intptr_t y_149) {
  ...
  intptr_t x_166; intptr_t x_894; intptr_t x_895;
  ...
  switch(x_151){
    case 4: //true_4
      ...
      break;
    case 5: //false_5
      x_153 = mkclo(fn1_loop_890, 2, 2);
      setclo(x_153, pred_118, 1);
      setclo(x_153, sub_131, 2);
      loop_152 = x_153;
      x_894 = appc(loop_152, x_148);
      x_895 = appc(x_894, y_149);
      x_166 = x_895;
      x_150 = x_166;
      break;
  }
...
intptr_t fn1_div_889(intptr_t* env) {
  intptr_t x_148; intptr_t y_149; intptr_t x_897;
  x_148 = env[1];
  y_149 = env[2];
...
intptr_t fn1_rem_899(intptr_t* env) {
  intptr_t x_168; intptr_t y_169; intptr_t x_900;
  x_168 = env[1];
  y_169 = env[2];
...
intptr_t fn0_rconsUU_901(intptr_t A_174, intptr_t __175, intptr_t __176) {
  ...
  switch(__175){
    ...
    default:
      ...
      x_182 = fn0_rconsUU_901(nothing, tl_181, __176);
...
intptr_t fn1_rconsUU_902(intptr_t* env) {
  intptr_t A_174; intptr_t __175; intptr_t __176; intptr_t x_903;
  A_174 = env[1];
  __175 = env[2];
  __176 = env[3];
...
intptr_t fn0_rconsUL_904(intptr_t A_185, intptr_t __186, intptr_t __187) {
  ...
  switch(__186){
    ...
    default:
      ...
      x_193 = fn0_rconsUL_904(nothing, tl_192, __187);
...
intptr_t fn1_rconsUL_905(intptr_t* env) {
  intptr_t A_185; intptr_t __186; intptr_t __187; intptr_t x_906;
  A_185 = env[1];
  __186 = env[2];
  __187 = env[3];
...
intptr_t fn0_rconsLL_907(intptr_t A_196, intptr_t __197, intptr_t __198) {
  ...
  switch(__197){
    ...
    default:
      ...
      x_204 = fn0_rconsLL_907(nothing, tl_203, __198);
...
intptr_t fn1_rconsLL_908(intptr_t* env) {
  intptr_t A_196; intptr_t __197; intptr_t __198; intptr_t x_909;
  A_196 = env[1];
  __197 = env[2];
  __198 = env[3];
...
intptr_t fn0_free_listUU_910(intptr_t A_207, intptr_t f_208, intptr_t __209) {
  ...
  intptr_t __214; intptr_t x_215; intptr_t x_216; intptr_t x_912;
  switch(__209){
    case 38: //nilUU_38
      x_210 = 27;
      break;
    default:
      ...
      x_912 = appc(f_208, hd_212);
      x_215 = x_912;
      __214 = x_215;
      x_216 = fn0_free_listUU_910(nothing, f_208, tl_213);
      x_211 = x_216;
      x_210 = x_211;
      break;
  }
...
intptr_t fn1_free_listUU_911(intptr_t* env) {
  intptr_t A_207; intptr_t f_208; intptr_t __209; intptr_t x_914;
  A_207 = env[1];
  f_208 = env[2];
  __209 = env[3];
...
intptr_t fn0_free_listUL_915(intptr_t A_218, intptr_t f_219, intptr_t __220) {
  ...
  intptr_t __225; intptr_t x_226; intptr_t x_227; intptr_t x_917;
  switch(__220){
    case 36: //nilUL_36
      x_221 = 27;
      break;
    default:
      ...
      x_917 = appc(f_219, hd_223);
      x_226 = x_917;
      __225 = x_226;
      x_227 = fn0_free_listUL_915(nothing, f_219, tl_224);
      x_222 = x_227;
      ffree(__220);
      x_221 = x_222;
      break;
...
intptr_t fn1_free_listUL_916(intptr_t* env) {
  intptr_t A_218; intptr_t f_219; intptr_t __220; intptr_t x_919;
  A_218 = env[1];
  f_219 = env[2];
  __220 = env[3];
...
intptr_t fn0_free_listLL_920(intptr_t A_229, intptr_t f_230, intptr_t __231) {
  ...
  intptr_t __236; intptr_t x_237; intptr_t x_238; intptr_t x_922;
  switch(__231){
    case 32: //nilLL_32
      x_232 = 27;
      break;
    default:
      ...
      x_922 = appc(f_230, hd_234);
      x_237 = x_922;
      __236 = x_237;
      x_238 = fn0_free_listLL_920(nothing, f_230, tl_235);
      x_233 = x_238;
      ffree(__231);
      x_232 = x_233;
      break;
...
intptr_t fn1_free_listLL_921(intptr_t* env) {
  intptr_t A_229; intptr_t f_230; intptr_t __231; intptr_t x_924;
  A_229 = env[1];
  f_230 = env[2];
  __231 = env[3];
...
intptr_t fn0_pow_925(intptr_t x_240, intptr_t y_241) {
  intptr_t loop_242; intptr_t x_243; intptr_t x_252; intptr_t x_931;
  intptr_t x_932;
  x_243 = mkclo(fn1_loop_927, 1, 2);
  setclo(x_243, x_240, 1);
  loop_242 = x_243;
  x_931 = appc(loop_242, 1);
  x_932 = appc(x_931, y_241);
  x_252 = x_932;
  return x_252;
}

intptr_t fn1_pow_926(intptr_t* env) {
  intptr_t x_240; intptr_t y_241; intptr_t x_934;
  x_240 = env[1];
  y_241 = env[2];
...
intptr_t fn0_powm_935(intptr_t x_254, intptr_t y_255, intptr_t m_256) {
  intptr_t loop_257; intptr_t x_258; intptr_t x_268; intptr_t x_941;
  intptr_t x_942;
  x_258 = mkclo(fn1_loop_937, 2, 2);
  setclo(x_258, x_254, 1);
  setclo(x_258, m_256, 2);
  loop_257 = x_258;
  x_941 = appc(loop_257, 1);
  x_942 = appc(x_941, y_255);
  x_268 = x_942;
  return x_268;
}

intptr_t fn1_powm_936(intptr_t* env) {
  intptr_t x_254; intptr_t y_255; intptr_t m_256; intptr_t x_944;
  x_254 = env[1];
  y_255 = env[2];
  m_256 = env[3];
...
intptr_t fn0_string_of_int_957(intptr_t i_283) {
  ...
  intptr_t x_309; intptr_t x_962; intptr_t x_964;
  x_285 = mkclo(fn1_aux_959, 3, 1);
...
intptr_t fn0_map_967(intptr_t A_311, intptr_t B_312, intptr_t f_313, intptr_t __314) {
  ...
  intptr_t x_323; intptr_t x_969;
  switch(ctagof(__314)){
    case 15: //Leaf_15
      x_316 = getbox(__314, 0);
      x_969 = appc(f_313, x_316);
      x_317 = x_969;
    ...
    case 16: //Node_16
      ...
      x_321 = fn0_map_967(nothing, nothing, f_313, l_319);
      x_322 = fn0_map_967(nothing, nothing, f_313, r_320);
...
intptr_t fn0_reduce_972(intptr_t A_325, intptr_t B_326, intptr_t f_327, intptr_t g_328, intptr_t __329) {
  ...
  intptr_t x_974; intptr_t x_976; intptr_t x_977;
  switch(ctagof(__329)){
    case 15: //Leaf_15
      x_331 = getbox(__329, 0);
      x_974 = appc(f_327, x_331);
      x_332 = x_974;
      x_330 = x_332;
      break;
    case 16: //Node_16
      ...
      x_336 = fn0_reduce_972(nothing, nothing, f_327, g_328, l_333);
      x_337 = fn0_reduce_972(nothing, nothing, f_327, g_328, r_334);
      x_976 = appc(g_328, x_336);
      x_977 = appc(x_976, x_337);
      x_335 = x_977;
      x_330 = x_335;
      break;
  }
...
intptr_t fn1_leaf_worker_981(intptr_t* env) {
  intptr_t A_339; intptr_t x_340; intptr_t c_341; intptr_t x_987;
  A_339 = env[1];
  x_340 = env[2];
  c_341 = env[3];
...
intptr_t fn1_node_worker_989(intptr_t* env) {
  ...
  intptr_t __367; intptr_t __368; intptr_t x_994;
  A_363 = env[1];
  l_364 = env[2];
  r_365 = env[3];
  __366 = env[4];
...
intptr_t fn1_cleaf_996(intptr_t* env) {
  intptr_t A_419; intptr_t x_420; intptr_t x_999;
  A_419 = env[1];
  x_420 = env[2];
...
intptr_t fn1_cnode_1001(intptr_t* env) {
  ...
  intptr_t __432; intptr_t x_1004;
  A_428 = env[1];
  l_429 = env[2];
  r_430 = env[3];
  __431 = env[4];
...
intptr_t fn0_ctree_of_tree_1005(intptr_t A_444, intptr_t t_445) {
  ...
  switch(ctagof(t_445)){
    case 15: //Leaf_15
      ...
      x_448 = fn0_cleaf_995(nothing, x_447);
      x_446 = x_448;
      break;
    case 16: //Node_16
      l_449 = getbox(t_445, 0);
      r_450 = getbox(t_445, 1);
      x_452 = fn0_ctree_of_tree_1005(nothing, l_449);
      x_453 = fn0_ctree_of_tree_1005(nothing, r_450);
      x_451 = fn0_cnode_1000(nothing, nothing, nothing, x_452, x_453);
      x_446 = x_451;
      break;
  }
  return x_446;
...
intptr_t fn1_ctree_of_tree_1006(intptr_t* env) {
  intptr_t A_444; intptr_t t_445; intptr_t x_1007;
  A_444 = env[1];
  t_445 = env[2];
...
intptr_t fn0_cfree_1008(intptr_t A_455, intptr_t t_456, intptr_t ct_457) {
  intptr_t x_458;
  x_458 = lazy(lazy__1010, 1);
  setlazy(x_458, ct_457, 0);
  return x_458;
}

intptr_t fn1_cfree_1009(intptr_t* env) {
  intptr_t A_455; intptr_t t_456; intptr_t ct_457; intptr_t x_1011;
  A_455 = env[1];
  t_456 = env[2];
  ct_457 = env[3];
...
intptr_t fn1_cmap_1013(intptr_t* env) {
  ...
  intptr_t ct_469; intptr_t x_1015;
  A_465 = env[1];
  B_466 = env[2];
  t_467 = env[3];
  f_468 = env[4];
...
intptr_t fn1_creduce_1017(intptr_t* env) {
  ...
  intptr_t g_481; intptr_t ct_482; intptr_t x_1020;
  A_477 = env[1];
  B_478 = env[2];
  t_479 = env[3];
  f_480 = env[4];
...
intptr_t fn1_splitU_1022(intptr_t* env) {
  intptr_t __497; intptr_t x_1023;
  __497 = env[1];
...
intptr_t fn1_splitL_1025(intptr_t* env) {
  intptr_t __517; intptr_t x_1026;
  __517 = env[1];
...
intptr_t fn1_mergeU_1028(intptr_t* env) {
  intptr_t __537; intptr_t __538; intptr_t x_1029;
  __537 = env[1];
  __538 = env[2];
...
intptr_t fn1_mergeL_1031(intptr_t* env) {
  intptr_t __557; intptr_t __558; intptr_t x_1032;
  __557 = env[1];
  __558 = env[2];
...
intptr_t fn1_msortU_1034(intptr_t* env) {
  intptr_t __577; intptr_t x_1035;
  __577 = env[1];
...
intptr_t fn1_msortL_1037(intptr_t* env) {
  intptr_t __597; intptr_t x_1038;
  __597 = env[1];
...
intptr_t fn1_splitting_tree_1040(intptr_t* env) {
  intptr_t __617; intptr_t x_1041;
  __617 = env[1];
...
intptr_t fn0_splitting_ctree_1042(intptr_t xs_641, intptr_t __642) {
  intptr_t x_643; intptr_t x_644; intptr_t x_650; intptr_t hd_651;
  intptr_t tl_652; intptr_t x_653; intptr_t x_654; intptr_t x_661;
  intptr_t hd_662; intptr_t tl_663; intptr_t x_664; intptr_t x_665;
  intptr_t x_666; intptr_t x_667; intptr_t m_668; intptr_t n_669;
  intptr_t x_670;
  switch(xs_641){
    case 38: //nilUU_38
      x_644 = lazy(lazy__1044, 2);
      setlazy(x_644, cleaf_418, 0);
      setlazy(x_644, __642, 1);
      x_643 = x_644;
      break;
    default:
      hd_651 = getbox(xs_641, 0);
      tl_652 = getbox(xs_641, 1);
      switch(tl_652){
        case 38: //nilUU_38
          x_654 = lazy(lazy__1045, 3);
          ...
          break;
        default:
          hd_662 = getbox(tl_652, 0);
          tl_663 = getbox(tl_652, 1);
          x_666 = mkbox(39, 2); //consUU_39
          setbox(x_666, hd_662, 0);
          setbox(x_666, tl_663, 1);
          x_667 = mkbox(39, 2); //consUU_39
          setbox(x_667, hd_651, 0);
          setbox(x_667, x_666, 1);
          x_665 = fn0_splitU_1021(x_667);
          m_668 = getbox(x_665, 0);
          n_669 = getbox(x_665, 1);
          x_670 = lazy(lazy__1046, 6);
...
intptr_t fn1_splitting_ctree_1043(intptr_t* env) {
  intptr_t xs_641; intptr_t __642; intptr_t x_1049;
  xs_641 = env[1];
  __642 = env[2];
...
intptr_t fn1_cmsort_1051(intptr_t* env) {
  intptr_t xs_705; intptr_t x_1056;
  xs_705 = env[1];
...
intptr_t fn0_mklistU_1057(intptr_t n_740) {
  intptr_t x_741; intptr_t x_742; intptr_t x_743; intptr_t x_744;
  intptr_t x_745;
  x_742 = __lte__(n_740, 0);
  switch(x_742){
    case 4: //true_4
      x_741 = 38;
      break;
    case 5: //false_5
      x_744 = __sub__(n_740, 1);
      x_743 = fn0_mklistU_1057(x_744);
      x_745 = mkbox(39, 2); //consUU_39
...
intptr_t fn1_mklistU_1058(intptr_t* env) {
  intptr_t n_740; intptr_t x_1059;
  n_740 = env[1];
...
intptr_t fn0_mklistL_1060(intptr_t n_747) {
  intptr_t x_748; intptr_t x_749; intptr_t x_750; intptr_t x_751;
  intptr_t x_752;
  x_749 = __lte__(n_747, 0);
  switch(x_749){
    case 4: //true_4
      x_748 = 36;
      break;
    case 5: //false_5
      x_751 = __sub__(n_747, 1);
      x_750 = fn0_mklistL_1060(x_751);
      x_752 = mkbox(37, 2); //consUL_37
...
intptr_t fn1_mklistL_1061(intptr_t* env) {
  intptr_t n_747; intptr_t x_1062;
  n_747 = env[1];
...
intptr_t fn0_list_lenU_1063(intptr_t __754) {
  intptr_t x_755; intptr_t x_756; intptr_t tl_758; intptr_t x_759;
  intptr_t x_760;
  switch(__754){
    case 38: //nilUU_38
      x_755 = 0;
      break;
    default:
      tl_758 = getbox(__754, 1);
      x_760 = fn0_list_lenU_1063(tl_758);
      x_759 = __add__(1, x_760);
      x_756 = x_759;
      x_755 = x_756;
      break;
  }
...
intptr_t fn1_list_lenU_1064(intptr_t* env) {
  intptr_t __754; intptr_t x_1065;
  __754 = env[1];
...
intptr_t fn0_list_lenL_1066(intptr_t __762) {
  intptr_t x_763; intptr_t x_764; intptr_t tl_766; intptr_t x_767;
  intptr_t x_768;
  switch(__762){
    case 36: //nilUL_36
      x_763 = 0;
      break;
    default:
      tl_766 = getbox(__762, 1);
      x_768 = fn0_list_lenL_1066(tl_766);
      x_767 = __add__(1, x_768);
      x_764 = x_767;
      ffree(__762);
      x_763 = x_764;
      break;
...
intptr_t fn1_list_lenL_1067(intptr_t* env) {
  intptr_t __762; intptr_t x_1068;
  __762 = env[1];
...
intptr_t fn0_print_listU_1069(intptr_t __770) {
  intptr_t x_771; intptr_t x_772; intptr_t x_775; intptr_t hd_776;
  intptr_t tl_777; intptr_t x_778;
  switch(__770){
    case 38: //nilUU_38
      x_772 = lazy(lazy__1071, 0);
      x_771 = x_772;
      break;
    default:
      hd_776 = getbox(__770, 0);
      tl_777 = getbox(__770, 1);
      x_778 = lazy(lazy__1072, 4);
...
intptr_t fn1_print_listU_1070(intptr_t* env) {
  intptr_t __770; intptr_t x_1073;
  __770 = env[1];
...
intptr_t fn0_print_listL_1074(intptr_t __788) {
  intptr_t x_789; intptr_t x_790; intptr_t x_793; intptr_t hd_794;
  intptr_t tl_795; intptr_t x_796;
  switch(__788){
    case 36: //nilUL_36
      x_790 = lazy(lazy__1076, 0);
      x_789 = x_790;
      break;
    default:
      hd_794 = getbox(__788, 0);
      tl_795 = getbox(__788, 1);
      x_796 = lazy(lazy__1077, 4);
...
intptr_t fn1_print_listL_1075(intptr_t* env) {
  intptr_t __788; intptr_t x_1078;
  __788 = env[1];
...
intptr_t lazy__1080(intptr_t* env) {
  intptr_t cmsort_704; intptr_t print_listU_769; intptr_t test_805;
  intptr_t _808; intptr_t x_809; intptr_t x_810; intptr_t x_811;
  intptr_t x_812;
  cmsort_704 = env[0];
...
intptr_t lazy__1077(intptr_t* env) {
  intptr_t string_of_int_282; intptr_t print_listL_787; intptr_t hd_794;
  intptr_t tl_795; intptr_t __797; intptr_t x_798; intptr_t x_799;
  intptr_t __800; intptr_t x_801; intptr_t x_802; intptr_t x_803;
  intptr_t x_804;
  ...
  x_798 = __print__(x_799);
  __797 = x_798;
  x_802 = __str__(" :: ");
  x_801 = __print__(x_802);
  __800 = x_801;
...
intptr_t lazy__1076(intptr_t* env) {
  intptr_t x_791; intptr_t x_792;
  x_792 = __str__("nil");
  x_791 = __print__(x_792);
  return x_791;
}

intptr_t lazy__1072(intptr_t* env) {
  intptr_t string_of_int_282; intptr_t print_listU_769; intptr_t hd_776;
  intptr_t tl_777; intptr_t __779; intptr_t x_780; intptr_t x_781;
  intptr_t __782; intptr_t x_783; intptr_t x_784; intptr_t x_785;
  intptr_t x_786;
  string_of_int_282 = env[0];
  print_listU_769 = env[1];
  hd_776 = env[2];
  ...
  x_780 = __print__(x_781);
  __779 = x_780;
  x_784 = __str__(" :: ");
  x_783 = __print__(x_784);
  __782 = x_783;
...
intptr_t lazy__1071(intptr_t* env) {
  intptr_t x_773; intptr_t x_774;
  x_774 = __str__("nil");
  x_773 = __print__(x_774);
  return x_773;
}

intptr_t lazy__1052(intptr_t* env) {
  intptr_t rwlUU_7; intptr_t cfree_454; intptr_t creduce_476;
  intptr_t mergeU_536; intptr_t splitting_ctree_640; intptr_t xs_705;
  intptr_t c_707; intptr_t x_708; intptr_t x_709; intptr_t _713;
  intptr_t x_714; intptr_t x_715; intptr_t m_716; intptr_t n_717;
  intptr_t __718; intptr_t x_719; intptr_t _720; intptr_t x_721;
  intptr_t x_722; intptr_t x_723; intptr_t x_726; intptr_t x_731;
  intptr_t m_732; intptr_t n_733; intptr_t result_734; intptr_t x_735;
  intptr_t __736; intptr_t x_737; intptr_t x_738;
  rwlUU_7 = env[0];
  cfree_454 = env[1];
  creduce_476 = env[2];
  mergeU_536 = env[3];
  ...
  xs_705 = env[5];
  x_709 = mkclo(fn1_lam_1053, 2, 1);
  setclo(x_709, splitting_ctree_640, 1);
  setclo(x_709, xs_705, 2);
  x_708 = __fork__(x_709);
  c_707 = x_708;
  x_714 = __recv1__(c_707);
  _713 = x_714;
  m_716 = getbox(_713, 0);
  n_717 = getbox(_713, 1);
  x_719 = __close1__(n_717);
  __718 = x_719;
  x_723 = mkclo(fn1_lam_1054, 0, 1);
  x_726 = mkclo(fn1_lam_1055, 1, 2);
  setclo(x_726, mergeU_536, 1);
  x_722 = fn0_creduce_1016(nothing, nothing, nothing, x_723, x_726, m_716);
  x_721 = force(x_722);
  ffree(x_722);
  _720 = x_721;
  m_732 = getbox(_720, 0);
  n_733 = getbox(_720, 1);
  x_735 = fn0_rwlUU_819(nothing, nothing, nothing, nothing, nothing, m_732);
  result_734 = x_735;
  x_738 = fn0_cfree_1008(nothing, nothing, n_733);
  x_737 = force(x_738);
  ffree(x_738);
  __736 = x_737;
  x_731 = result_734;
...
intptr_t fn1_lam_1053(intptr_t* env) {
  intptr_t splitting_ctree_640; intptr_t xs_705; intptr_t lam_710;
  intptr_t _711; intptr_t x_712;
  lam_710 = env[0];
...
intptr_t fn1_lam_1054(intptr_t* env) {
  intptr_t lam_724; intptr_t x_725;
  lam_724 = env[0];
  x_725 = env[1];
  return x_725;
}
...
intptr_t fn1_lam_1055(intptr_t* env) {
  intptr_t mergeU_536; intptr_t lam_727; intptr_t l_728; intptr_t r_729;
  intptr_t x_730;
  lam_727 = env[0];
  mergeU_536 = env[1];
  l_728 = env[2];
...
intptr_t lazy__1046(intptr_t* env) {
  intptr_t rwlUL_14; intptr_t cnode_427; intptr_t splitting_ctree_640;
  intptr_t __642; intptr_t m_668; intptr_t n_669; intptr_t cl_671;
  intptr_t x_672; intptr_t x_673; intptr_t cr_677; intptr_t x_678;
  intptr_t x_679; intptr_t _683; intptr_t x_684; intptr_t x_685;
  intptr_t m_686; intptr_t n_687; intptr_t __688; intptr_t x_689;
  intptr_t _690; intptr_t x_691; intptr_t x_692; intptr_t m_693;
  intptr_t n_694; intptr_t __695; intptr_t x_696; intptr_t ct_697;
  intptr_t x_698; intptr_t ct_699; intptr_t x_700; intptr_t c_701;
  intptr_t x_702; intptr_t x_703;
  rwlUL_14 = env[0];
  cnode_427 = env[1];
  ...
  m_668 = env[4];
  n_669 = env[5];
  x_673 = mkclo(fn1_lam_1047, 2, 1);
  setclo(x_673, splitting_ctree_640, 1);
  setclo(x_673, m_668, 2);
  x_672 = __fork__(x_673);
  cl_671 = x_672;
  x_679 = mkclo(fn1_lam_1048, 2, 1);
  setclo(x_679, splitting_ctree_640, 1);
  setclo(x_679, n_669, 2);
  x_678 = __fork__(x_679);
  cr_677 = x_678;
  x_684 = __recv1__(cl_671);
  _683 = x_684;
  m_686 = getbox(_683, 0);
  n_687 = getbox(_683, 1);
  x_689 = __close1__(n_687);
  __688 = x_689;
  x_691 = __recv1__(cr_677);
  _690 = x_691;
  m_693 = getbox(_690, 0);
  n_694 = getbox(_690, 1);
  x_696 = __close1__(n_694);
  __695 = x_696;
  x_698 = fn0_cnode_1000(nothing, nothing, nothing, m_686, m_693);
  ct_697 = x_698;
  x_700 = fn0_rwlUL_822(nothing, nothing, nothing, nothing, nothing, ct_697);
  ct_699 = x_700;
  x_702 = __send__(__642, ct_699);
  c_701 = x_702;
  x_703 = __close0__(c_701);
  x_692 = x_703;
  ffree(_690);
  x_685 = x_692;
  ffree(_683);
...
intptr_t fn1_lam_1047(intptr_t* env) {
  intptr_t splitting_ctree_640; intptr_t m_668; intptr_t lam_674;
  intptr_t _675; intptr_t x_676;
  lam_674 = env[0];
  splitting_ctree_640 = env[1];
  m_668 = env[2];
  _675 = env[3];
...
intptr_t fn1_lam_1048(intptr_t* env) {
  intptr_t splitting_ctree_640; intptr_t n_669; intptr_t lam_680;
  intptr_t _681; intptr_t x_682;
  lam_680 = env[0];
  splitting_ctree_640 = env[1];
  n_669 = env[2];
  _681 = env[3];
...
intptr_t lazy__1045(intptr_t* env) {
  intptr_t cleaf_418; intptr_t __642; intptr_t hd_651; intptr_t c_655;
  intptr_t x_656; intptr_t x_657; intptr_t x_658; intptr_t __659;
  intptr_t x_660;
  cleaf_418 = env[0];
  __642 = env[1];
  hd_651 = env[2];
  x_658 = mkbox(39, 2); //consUU_39
  setbox(x_658, hd_651, 0);
  setbox(x_658, 38, 1);
  x_657 = fn0_cleaf_995(nothing, x_658);
  x_656 = __send__(__642, x_657);
  c_655 = x_656;
  x_660 = __close0__(c_655);
  __659 = x_660;
  return 27;
}

intptr_t lazy__1044(intptr_t* env) {
  intptr_t cleaf_418; intptr_t __642; intptr_t c_645; intptr_t x_646;
  intptr_t x_647; intptr_t __648; intptr_t x_649;
  cleaf_418 = env[0];
  __642 = env[1];
  x_647 = fn0_cleaf_995(nothing, 38);
  x_646 = __send__(__642, x_647);
  c_645 = x_646;
  x_649 = __close0__(c_645);
  __648 = x_649;
  return 27;
}
...
intptr_t fn1_lam_1003(intptr_t* env) {
  ...
  r_ch_436 = env[3];
  _441 = env[4];
  x_442 = fn0_node_worker_988(nothing, nothing, nothing, l_ch_434, r_ch_436, _441);
  return x_442;
}
...
intptr_t fn1_lam_998(intptr_t* env) {
  ...
  x_420 = env[2];
  _425 = env[3];
  x_426 = fn0_leaf_worker_980(nothing, x_420, _425);
  return x_426;
}
    ...
    default:
      switch(ctagof(m_373)){
        case 18: //Map_18
          ...
          r_ch_390 = x_391;
          x_394 = fn0_node_worker_988(nothing, nothing, nothing, l_ch_387, r_ch_390, n_374);
          x_393 = force(x_394);
          ffree(x_394);
          x_385 = x_393;
          break;
        case 19: //Reduce_19
          ...
          m_411 = getbox(_408, 0);
          n_412 = getbox(_408, 1);
          x_991 = appc(g_396, m_406);
          x_992 = appc(x_991, m_411);
          x_415 = x_992;
          x_414 = __send__(n_374, x_415);
          c_413 = x_414;
          x_417 = fn0_node_worker_988(nothing, nothing, nothing, n_407, n_412, c_413);
          x_416 = force(x_417);
          ffree(x_417);
          x_410 = x_416;
          ffree(_408);
...
intptr_t lazy__982(intptr_t* env) {
  ...
  intptr_t x_361; intptr_t x_983; intptr_t x_985;
  leaf_worker_338 = env[0];
  x_340 = env[1];
  c_341 = env[2];
    ...
    default:
      switch(ctagof(m_346)){
        case 18: //Map_18
          ...
          x_983 = appc(f_351, x_340);
          x_354 = x_983;
          x_353 = fn0_leaf_worker_980(nothing, x_354, n_347);
          x_352 = force(x_353);
          ffree(x_353);
          x_350 = x_352;
          ffree(m_346);
        ...
        case 19: //Reduce_19
          ...
          x_985 = appc(f_355, x_340);
          x_359 = x_985;
          x_358 = __send__(n_347, x_359);
          c_357 = x_358;
          x_361 = fn0_leaf_worker_980(nothing, x_340, c_357);
          x_360 = force(x_361);
          ffree(x_361);
          x_350 = x_360;
          ffree(m_346);
...
intptr_t fn1_loop_937(intptr_t* env) {
  ...
  intptr_t x_265; intptr_t x_266; intptr_t x_267; intptr_t x_938;
  intptr_t x_939;
  loop_259 = env[0];
  x_254 = env[1];
  m_256 = env[2];
  ...
  switch(x_263){
    ...
    case 5: //false_5
      ...
      x_938 = appc(loop_259, x_265);
      x_939 = appc(x_938, x_267);
      x_264 = x_939;
      x_262 = x_264;
      break;
  }
...
intptr_t fn1_loop_927(intptr_t* env) {
  ...
  intptr_t x_251; intptr_t x_928; intptr_t x_929;
  loop_244 = env[0];
  x_240 = env[1];
  acc_245 = env[2];
  y_246 = env[3];
  ...
  switch(x_248){
    ...
    case 5: //false_5
      ...
      x_928 = appc(loop_244, x_250);
      x_929 = appc(x_928, x_251);
      x_249 = x_929;
      x_247 = x_249;
      break;
  }
...
intptr_t fn1_loop_890(intptr_t* env) {
  ...
  intptr_t x_164; intptr_t x_165; intptr_t x_891; intptr_t x_892;
  loop_154 = env[0];
  pred_118 = env[1];
  sub_131 = env[2];
  x_155 = env[3];
  ...
  switch(x_158){
    ...
    default:
      ...
      x_891 = appc(loop_154, n_163);
      x_892 = appc(x_891, y_156);
      x_164 = x_892;
...
int main() {
  begin_run();
  intptr_t test_805; intptr_t x_806; intptr_t x_807; intptr_t x_1079;
  idU_1 = mkclo(fn1_idU_814, 0, 2);
  idL_4 = mkclo(fn1_idL_817, 0, 2);
  rwlUU_7 = mkclo(fn1_rwlUU_820, 0, 6);
  rwlUL_14 = mkclo(fn1_rwlUL_823, 0, 6);
  rwlLU_21 = mkclo(fn1_rwlLU_826, 0, 6);
  rwlLL_28 = mkclo(fn1_rwlLL_829, 0, 6);
  rwrUU_35 = mkclo(fn1_rwrUU_832, 0, 6);
  rwrUL_42 = mkclo(fn1_rwrUL_835, 0, 6);
  rwrLU_49 = mkclo(fn1_rwrLU_838, 0, 6);
  rwrLL_56 = mkclo(fn1_rwrLL_841, 0, 6);
  sing_elimUU_63 = mkclo(fn1_sing_elimUU_844, 0, 3);
  sing_elimUL_67 = mkclo(fn1_sing_elimUL_847, 0, 3);
  sing_elimLU_71 = mkclo(fn1_sing_elimLU_850, 0, 3);
  sing_elimLL_75 = mkclo(fn1_sing_elimLL_853, 0, 3);
  not_79 = mkclo(fn1_not_856, 0, 1);
  and_82 = mkclo(fn1_and_859, 0, 2);
  or_87 = mkclo(fn1_or_862, 0, 2);
  xor_92 = mkclo(fn1_xor_865, 0, 2);
  string_of_bool_98 = mkclo(fn1_string_of_bool_868, 0, 1);
  lte_103 = mkclo(fn1_lte_871, 0, 2);
  lt_113 = mkclo(fn1_lt_874, 0, 2);
  pred_118 = mkclo(fn1_pred_877, 0, 1);
  add_123 = mkclo(fn1_add_880, 0, 2);
  sub_131 = mkclo(fn1_sub_883, 0, 2);
  mul_139 = mkclo(fn1_mul_886, 0, 2);
  div_147 = mkclo(fn1_div_889, 0, 2);
  rem_167 = mkclo(fn1_rem_899, 0, 2);
  rconsUU_173 = mkclo(fn1_rconsUU_902, 0, 3);
  rconsUL_184 = mkclo(fn1_rconsUL_905, 0, 3);
  rconsLL_195 = mkclo(fn1_rconsLL_908, 0, 3);
  free_listUU_206 = mkclo(fn1_free_listUU_911, 0, 3);
  free_listUL_217 = mkclo(fn1_free_listUL_916, 0, 3);
  free_listLL_228 = mkclo(fn1_free_listLL_921, 0, 3);
  pow_239 = mkclo(fn1_pow_926, 0, 2);
  powm_253 = mkclo(fn1_powm_936, 0, 3);
  ord_269 = mkclo(fn1_ord_946, 0, 1);
  chr_272 = mkclo(fn1_chr_949, 0, 1);
  str_275 = mkclo(fn1_str_952, 0, 1);
  strlen_279 = mkclo(fn1_strlen_955, 0, 1);
  string_of_int_282 = mkclo(fn1_string_of_int_958, 0, 1);
  map_310 = mkclo(fn1_map_968, 0, 4);
  reduce_324 = mkclo(fn1_reduce_973, 0, 5);
  leaf_worker_338 = mkclo(fn1_leaf_worker_981, 0, 3);
  node_worker_362 = mkclo(fn1_node_worker_989, 0, 6);
  cleaf_418 = mkclo(fn1_cleaf_996, 0, 2);
  cnode_427 = mkclo(fn1_cnode_1001, 0, 5);
  ctree_of_tree_443 = mkclo(fn1_ctree_of_tree_1006, 0, 2);
  cfree_454 = mkclo(fn1_cfree_1009, 0, 3);
  cmap_464 = mkclo(fn1_cmap_1013, 0, 5);
  creduce_476 = mkclo(fn1_creduce_1017, 0, 6);
  splitU_496 = mkclo(fn1_splitU_1022, 0, 1);
  splitL_516 = mkclo(fn1_splitL_1025, 0, 1);
  mergeU_536 = mkclo(fn1_mergeU_1028, 0, 2);
  mergeL_556 = mkclo(fn1_mergeL_1031, 0, 2);
  msortU_576 = mkclo(fn1_msortU_1034, 0, 1);
  msortL_596 = mkclo(fn1_msortL_1037, 0, 1);
  splitting_tree_616 = mkclo(fn1_splitting_tree_1040, 0, 1);
  splitting_ctree_640 = mkclo(fn1_splitting_ctree_1043, 0, 2);
  cmsort_704 = mkclo(fn1_cmsort_1051, 0, 1);
  mklistU_739 = mkclo(fn1_mklistU_1058, 0, 1);
  mklistL_746 = mkclo(fn1_mklistL_1061, 0, 1);
  list_lenU_753 = mkclo(fn1_list_lenU_1064, 0, 1);
  list_lenL_761 = mkclo(fn1_list_lenL_1067, 0, 1);
  print_listU_769 = mkclo(fn1_print_listU_1070, 0, 1);
  print_listL_787 = mkclo(fn1_print_listL_1075, 0, 1);
  x_806 = fn0_mklistU_1057(100);
  test_805 = x_806;
  x_807 = lazy(lazy__1080, 3);
