...
Proof.
  ...
  apply: (star_hom ((Lam0^~ m)^~ s)) r1=>x y. exact: sta_lam0L.
  apply: (star_hom ((Lam0 A')^~ s)) r2=>x y. exact: sta_lam0R.
Qed.
...
Proof.
  ...
  apply: (star_hom ((Lam1^~ m)^~ s)) r1=>x y. exact: sta_lam1L.
  apply: (star_hom ((Lam1 A')^~ s)) r2=>x y. exact: sta_lam1R.
Qed.
...
Proof.
  ...
  apply: (star_hom ((Pi0^~ B)^~ s)) r1=>x y. exact: sta_pi0L.
  apply: (star_hom ((Pi0 A')^~ s)) r2=>x y. exact: sta_pi0R.
Qed.
...
Proof.
  ...
  apply: (star_hom ((Pi1^~ B)^~ s)) r1=>x y. exact: sta_pi1L.
  apply: (star_hom ((Pi1 A')^~ s)) r2=>x y. exact: sta_pi1R.
Qed.
...
Proof.
  ...
  apply: (conv_hom ((Lam0^~ m)^~ s)) r1=>x y. exact: sta_lam0L.
  apply: (conv_hom ((Lam0 A')^~ s)) r2=>x y. exact: sta_lam0R.
Qed.
...
Proof.
  ...
  apply: (conv_hom ((Lam1^~ m)^~ s)) r1=>x y. exact: sta_lam1L.
  apply: (conv_hom ((Lam1 A')^~ s)) r2=>x y. exact: sta_lam1R.
Qed.
...
Proof.
  ...
  apply: (conv_hom ((Pi0^~ B)^~ s)) r1=>x y. exact: sta_pi0L.
  apply: (conv_hom ((Pi0 A')^~ s)) r2=>x y. exact: sta_pi0R.
Qed.
...
Proof.
  ...
  apply: (conv_hom ((Pi1^~ B)^~ s)) r1=>x y. exact: sta_pi1L.
  apply: (conv_hom ((Pi1 A')^~ s)) r2=>x y. exact: sta_pi1R.
Qed.
