...
| logical_val_var x :
  logical_val (Var x)
| logical_val_sort s l :
  logical_val (Sort s l)
...
| logical_val_bool : logical_val Bool
| logical_val_tt : logical_val TT
| logical_val_ff : logical_val FF
...
| logical_step_ifteA A A' m n1 n2 :
  A ~> A' ->
  Ifte A m n1 n2 ~> Ifte A' m n1 n2
| logical_step_ifteM A m m' n1 n2 :
  m ~> m' ->
  Ifte A m n1 n2 ~> Ifte A m' n1 n2
| logical_step_ifteN1 A m n1 n1' n2 :
  n1 ~> n1' ->
  Ifte A m n1 n2 ~> Ifte A m n1' n2
| logical_step_ifteN2 A m n1 n2 n2' :
  n2 ~> n2' ->
  Ifte A m n1 n2 ~> Ifte A m n1 n2'
| logical_step_ifteT A n1 n2 :
  Ifte A TT n1 n2 ~> n1
| logical_step_ifteF A n1 n2 :
  Ifte A FF n1 n2 ~> n2
