...
Proof with eauto using
  ...
  { move=>Γ Δ A B H P m n s h tyB tyH ihH tyP Γ' Δ' ξ agr. asimpl.
    ...
    have e:=closed_isubst h (isubst0 (ren ξ)).
    rewrite e in h.
    have pf:=program_rw h ihB. asimpl in pf.
