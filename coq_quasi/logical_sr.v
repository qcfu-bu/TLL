(* This file presents the subject reduction theorem of the logical
   level. *)
...
Proof with eauto using logical0_type, logical0_wf, logical_step, logical_type.
  move=>/logical_logical0_reflect ty st. apply: logical0_logical_reflect.
  elim: ty n st=>{Γ m A}...
  ...
  { move=>Γ A B s r t tyA ihA tyB ihB n st. inv st.
    { have tyA':=ihA _ H3.
      apply: logical0_pi0...
      apply: logical_logical0_reflect.
      move/logical0_logical_reflect in tyB.
      move/logical0_logical_reflect in tyA'.
  ...
  { move=>Γ A B m s r tyA ihA tym ihm n st. inv st.
    { have tyA':=ihA _ H3.
      move/logical0_logical_reflect in tym.
      move/logical0_logical_reflect in tyA'.
  ...
  { move=>Γ A B m n s tym ihm tyn ihn x st. inv st.
    { have tym':=ihm _ H2... }
    { have tyn':=ihn _ H2.
      move/logical0_logical_reflect in tyn.
      have[_/logical_pi0_inv[r[tyB _]]]:=logical_valid (logical0_logical_reflect tym).
      apply: logical0_conv.
      ...
      by autosubst. }
    { have[x tyP]:=logical_valid (logical0_logical_reflect tym).
      have/logical_lam0_inv tym0:=logical0_logical_reflect tym.
      move/logical0_logical_reflect in tyn.
      apply: logical_logical0_reflect.
      apply: logical_esubst... }
    { exfalso. apply: logical_lam1_pi0_false.
      apply: logical0_logical_reflect... eauto. } }
  { move=>Γ A B m n s tym ihm tyn ihn x st. inv st.
    { have tym':=ihm _ H2... }
    { have tyn':=ihn _ H2.
      move/logical0_logical_reflect in tyn.
      have[_/logical_pi1_inv[r[tyB _]]]:=logical_valid (logical0_logical_reflect tym).
      apply: logical0_conv.
      apply: logical_conv_beta.
      apply: conv1i...
      apply: logical0_app1...
    ...
    { exfalso. apply: logical_lam0_pi1_false.
      apply: logical0_logical_reflect... eauto. } 
    { have[x tyP]:=logical_valid (logical0_logical_reflect tym).
      have/logical_lam1_inv tym0:=logical0_logical_reflect tym.
      move/logical0_logical_reflect in tyn.
      apply: logical_logical0_reflect.
      apply: logical_esubst... } }
  ...
  { move=>Γ A B m n t tyS ihS tym ihm tyn ihn x st. inv st.
    { have/logical0_logical_reflect tym':=ihm _ H3.
      have tyS':=logical0_logical_reflect tyS.
  ...
  { move=>Γ A B C m n s t tyC ihC tym ihm tyn ihn x st. inv st.
    { have/logical0_logical_reflect tyA':=ihC _ H3.
      move/logical0_logical_reflect in tyC.
      move/logical0_logical_reflect in tym.
  ...
  { move=>Γ A B H P m n s tyB ihB tyH ihH tyP ihP n0 st. inv st.
    { have/logical0_logical_reflect tyA':=ihB _ H5.
      move/logical0_logical_reflect in tyB.
      move/logical0_logical_reflect in tyH.
      move/logical0_logical_reflect in tyP.
    ...
    { have/logical0_logical_reflect tyP':=ihP _ H5.
      move/logical0_logical_reflect in tyB.
      move/logical0_logical_reflect in tyH.
      move/logical0_logical_reflect in tyP.
      have[r tyI]:=logical_valid tyP.
