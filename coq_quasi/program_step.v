(* This file defines the operational semantics of the program level. *)
...
| program_step_appL m m' n :
  m ~>> m' ->
  App m n ~>> App m' n
| program_step_appR A m n n' s :
  n ~>> n' ->
  App (Lam1 A m s) n ~>> App (Lam1 A m s) n'
...
Notation "m ~>>* n" := (program_red m n) (at level 30).
