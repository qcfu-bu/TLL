...
(* Alternative typing rules for the logical level.
   ...
   hypothesis for A during induction. We will show later that the
...
Lemma logical_logical0_reflect Γ m A : Γ ⊢ m : A -> logical0_type Γ m A.
Proof with eauto using logical0_type, logical0_wf.
  ...
  Unshelve. eauto.
Qed.
Hint Resolve logical_logical0_reflect.

Lemma logical0_logical_reflect Γ m A : logical0_type Γ m A -> Γ ⊢ m : A.
