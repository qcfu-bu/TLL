...
(* program_empty Δ means that all positions in Δ are empty *)
Inductive program_empty : program_ctx -> Prop :=
| program_empty_O : program_empty nil
| program_empty_S Δ : program_empty Δ -> program_empty (_: Δ).
...
Lemma program_has_empty Δ x s A :
  program_has Δ x s A -> program_empty Δ -> False.
Proof with eauto.
  elim=>{Δ x s A}.
...
Lemma program_empty_split Δ1 Δ2 Δ :
  Δ1 ∘ Δ2 => Δ -> program_empty Δ -> program_empty Δ1 /\ program_empty Δ2.
Proof with eauto using program_empty.
  elim=>{Δ1 Δ2 Δ}...
...
Lemma program_empty_uniq Δ1 Δ2 :
  program_empty Δ1 -> program_empty Δ2 -> size Δ1 = size Δ2 -> Δ1 = Δ2.
Proof with eauto.
...
Lemma program_empty_key Δ s : program_empty Δ -> Δ ▷ s.
Proof with eauto using key. elim... Qed.

Lemma program_empty_self Δ : program_empty Δ -> Δ ∘ Δ => Δ.
Proof with eauto using merge. elim... Qed.
