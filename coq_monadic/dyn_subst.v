...
Proof with eauto using dyn_agree_subst, dyn_agree_subst_key, dyn_type.
  ...
  { move=>Γ Δ1 Δ2 Δ A B m n s mrg tym ihm tyn ihn Γ1 Δ0 σ agr. asimpl.
    ...
    apply: dyn_app1... }
  { move=>Γ Δ k wf ih Γ1 Δ1 σ agr. asimpl. apply: dyn_it... }
  { move=>Γ Δ n k wf ih Γ1 Δ1 σ agr. asimpl. apply: dyn_num... }
  { move=>Γ Δ k wf ih Γ1 Δ1 σ agr. asimpl. apply: dyn_rand... }
  { move=>Γ Δ m A tym ih Γ1 Δ1 σ agr. asimpl. apply: dyn_return... }
  { move=>Γ Δ1 Δ2 Δ m n A B s t mrg tyB tym ihm tyn ihn Γ1 Δ0 σ agr. asimpl.
    have wf:=dyn_type_wf tyn. inv wf.
    have[Δa[Δb[mrg0[agra agrb]]]]:=dyn_agree_subst_merge agr mrg.
    have/=tyB':=sta_substitution tyB (dyn_sta_agree_subst agr).
    have{}ihm:=ihm _ _ _ agra.
    have{}ihn:=ihn _ _ _ (dyn_agree_subst_ty agrb H4).
    apply: dyn_letin...
    asimpl in ihn.
    asimpl... }
