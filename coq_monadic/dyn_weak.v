...
Proof with eauto using dyn_type, dyn_agree_ren, dyn_agree_ren_key.
  ...
  { move=>Γ Δ1 Δ2 Δ A B m n s mrg tym ihm tyn ihn Γ' Δ' ξ agr. asimpl.
    ...
    apply: dyn_app1...
    asimpl in ihm... }
  { move=>Γ Δ k wf ih Γ' Δ' ξ agr. asimpl. apply: dyn_it... }
  { move=>Γ Δ n k wf ih Γ' Δ' ξ agr. asimpl. apply: dyn_num... }
  { move=>Γ Δ k wf ih Γ' Δ' ξ agr. asimpl. apply: dyn_rand... }
  { move=>Γ Δ m A tym ihm Γ' Δ' ξ agr. asimpl. apply: dyn_return... }
  { move=>Γ Δ1 Δ2 Δ m n A B s t mrg tyB tym ihm tyn ihn Γ' Δ' ξ agr. asimpl.
    have wf:=dyn_type_wf tyn. inv wf.
    have[Δ1'[Δ2'[mrg'[arg1 arg2]]]]:=dyn_agree_ren_merge agr mrg.
    have/ihn tyn':=dyn_agree_ren_ty H4 arg2.
