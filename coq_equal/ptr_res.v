...
Proof with eauto using key_impure.
  ...
  { move=>Γ Δ A B m m' n s erm _ tyn H z s0 e1 e2 rs tyB vl. inv vl. }
  { move=>Γ Δ1 Δ2 Δ A B m m' n n' s mrg erm _ ern _ H z s0 e1 e2 rs tyB vl. inv vl. }
