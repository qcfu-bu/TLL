...
\begin{theorem}
  For any static typing $\Gamma \vdash m : A$ and static reduction $m \leadsto n$, the judgment $\Gamma \vdash n : A$ is derivable.
\end{theorem}
...
\begin{theorem}
  For any dynamic typing $\Gamma ; \Delta \vdash m : A$ and dynamic reduction $m \Leadsto n$, the judgment $\Gamma ; \Delta \vdash n : A$ is derivable.
\end{theorem}
...
\begin{theorem}
  For any dynamic typing $\Gamma ; \Delta \vdash m : A$, there exists $m'$ such that $\Gamma ; \Delta \vdash m \sim m' : A$.
\end{theorem}
